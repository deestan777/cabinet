            ...
            if (splitItem.insertAdjacentHTML && newMenus) {
                splitItem.insertAdjacentHTML(
                    ...
                    `<li class="relative group-data-[layout=horizontal]:shrink-0 group/sm more-menu">\
                            ...
                            <ul class="rtl:pl-[1.75rem] rtl:pr-[1.75rem] group-data-[sidebar-size=md]:rtl:pl-0 group-data-[sidebar-size=md]:rtl:pr-0 group-data-[sidebar-size=sm]:rtl:pl-0 group-data-[sidebar-size=sm]:rtl:pr-0 group-data-[sidebar-size=sm]:py-2 group-data-[layout=horizontal]:rtl:pl-0 group-data-[layout=horizontal]:rtl:pr-0">
                                <ul class="rtl:pl-[1.75rem] rtl:pr-[1.75rem] group-data-[sidebar-size=md]:rtl:pl-0 group-data-[sidebar-size=md]:rtl:pr-0 group-data-[sidebar-size=sm]:rtl:pl-0 group-data-[sidebar-size=sm]:rtl:pr-0 group-data-[sidebar-size=sm]:py-2 group-data-[layout=horizontal]:rtl:pl-0 group-data-[layout=horizontal]:rtl:pr-0">
